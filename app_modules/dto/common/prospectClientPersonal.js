...
prospect_client_personal.prototype = {
    ...
    getRemarksKycRejection: function(){

        return this.remarksKycRejection;
    },

    setRemarksKycRejection: function (remarksKycRejection){
        this.remarksKycRejection = remarksKycRejection;
    },

    getBusinessCategoryId: function(){
        return this.businessCategoryId;
    },

    setBusinessCategoryId: function (businessCategoryId){
	...
	clearAll: function() {
		...
		this.setNationality("");
		this.setRemarks("");
        this.setRemarksKycRejection("");
        this.setBusinessCategoryId("");
