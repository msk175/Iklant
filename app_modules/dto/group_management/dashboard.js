...
choicesSelectedAnswer.prototype = {
    ...
    setGrtCount: function (t_grt_count){
        this.grt_count = t_grt_count;
    },

    getGrtCount: function(){
        return this.grt_count;
    },
    setIdleCount: function (t_idle_count){
        this.idle_count = t_idle_count;
    },

    getIdleCount: function(){
