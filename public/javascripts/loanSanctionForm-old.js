...
function goToRepaymentSchedule(){
	...
	document.getElementById("BMFormId").action="/mfi/api/1.0/client/ci/loanrecovery/groups/"+globalCustomerNum+"/loanaccounts";
	document.getElementById("BMFormId").submit();
}
function showPageExpired(){
	document.getElementById("BMFormId").method='POST';
	document.getElementById("BMFormId").action="/mfi/api/1.0/client/ci/showErrorPage";
	document.getElementById("BMFormId").submit();
}
...
function docVerification(){
	...
	document.getElementById("BMFormId").method='POST';
	document.getElementById("BMFormId").action="/mfi/api/1.0/client/ci/groups/member/docVerification";
	document.getElementById("BMFormId").submit();
}
