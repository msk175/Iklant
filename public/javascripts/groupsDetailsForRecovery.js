...
$(document).ready(function() {
	...
	if($("#loanstatus").val() == 0){
		...
		//$("#reason option[value='3']").attr("selected", true);
...
/*function calculateExpectedPaymentDate() {
	var capabilityPercentage = $("#percentageId").val();
	if(capabilityPercentage == '100') {
		
	}
	else if(capabilityPercentage == '95') {
		$("#approvalDateId").val(formatDateForUI(new Date(), 15));
	}
	else if(capabilityPercentage == '80') {
		$("#approvalDateId").val(formatDateForUI(new Date(), 30));
	}
	else if(capabilityPercentage == '60') {
		$("#approvalDateId").val(formatDateForUI(new Date(), 45));
	}
	else if(capabilityPercentage == '40') {
		$("#approvalDateId").val(formatDateForUI(new Date(), 60));
	}
	else if(capabilityPercentage == '20') {
		$("#approvalDateId").val(formatDateForUI(new Date(), 75));
	}
	else if(capabilityPercentage == '10') {
		$("#approvalDateId").val(formatDateForUI(new Date(), 90));
	}
	else if(capabilityPercentage == '5') {
		$("#approvalDateId").val(formatDateForUI(new Date(), 90));
	}
	else if(capabilityPercentage == '1') {
		$("#approvalDateId").val(formatDateForUI(new Date(), 90));
	}
}*/
...
/*function formatDateForUI(tempDate, addDays) {
