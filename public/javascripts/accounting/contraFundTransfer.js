...
function contraFundTransfer(){
	...
	if($("#fromOfficeHierarchyId").val() == ""){
        ...
        document.getElementById("accountsMenuFormID").action=localStorage.contextPath+"/accounts/submitFundTransfer";
	...
	ajaxVariable = $.ajax({
		...
		url: 'http://'+ajaxcallip+'/mfi/api/1.0/accounts/submitFundTransfer',
		success: function(data) {
			if(data.fundTransfer == "success"){
				showFundTransferForm();
			}else if(data.fundTransfer == "failure"){
