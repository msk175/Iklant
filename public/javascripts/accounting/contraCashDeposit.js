...
function contraCashDeposit(){
	...
	if($("#fromOfficeHierarchyId").val() == ""){
        ...
        document.getElementById("accountsMenuFormID").action=localStorage.contextPath+"/accounts/submitcashDeposit";
	...
	ajaxVariable = $.ajax({
		...
		url: 'http://'+ajaxcallip+'/mfi/api/1.0/accounts/submitcashDeposit',
		success: function(data) {
			if(data.cashDeposit == "success"){
				showCashDepositForm();
			}else if(data.cashDeposit == "failure"){
