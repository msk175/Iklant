...
$("#pageID").live('pageshow',function() {
	...
	$("#transactionNotesId").keydown(function(event) {
        // Allow: backspace, delete, tab, escape,spacebar and enter
...
function contraBankWithDraw(){
	...
	if($("#fromOfficeHierarchyId").val() == ""){
        ...
        document.getElementById("accountsMenuFormID").action=localStorage.contextPath+"/accounts/submitContraBankWithdraw";
	...
	ajaxVariable = $.ajax({
		...
		url: 'http://'+ajaxcallip+'/mfi/api/1.0/accounts/submitContraBankWithdraw',
