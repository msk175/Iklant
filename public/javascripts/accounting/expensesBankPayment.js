...
function expensesBankPayment(){
	...
	if($("#fromOfficeHierarchyId").val() == ""){
        ...
        document.getElementById("accountsMenuFormID").action=localStorage.contextPath+"/accounts/submitBankPayment";
	...
	ajaxVariable = $.ajax({
		...
		url: 'http://'+ajaxcallip+'/mfi/api/1.0/accounts/submitBankPayment',
		success: function(data) {
			if(data.bankPayment == "success"){
				showBankPaymentExpensesForm();
			}else if(data.bankPayment == "failure"){
