...
function expensesCashReceipt(){
	...
	if($("#fromOfficeHierarchyId").val() == ""){
        ...
        document.getElementById("accountsMenuFormID").action=localStorage.contextPath+"/accounts/submitCashReceipt";
	...
	ajaxVariable = $.ajax({
		...
		url: 'http://'+ajaxcallip+'/mfi/api/1.0/accounts/submitCashReceipt',
		success: function(data) {
			if(data.cashReceipt == "success"){
				showCashReceiptForm();
			}else if(data.cashReceipt == "failure"){
