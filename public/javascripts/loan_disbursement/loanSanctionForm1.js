			...
			success: function(data) {
				...
				for(var i=0;i<data.SanctionLoanHolderLocal.clientSelectForGroup.length;i++){
					...
					if(i == 0){
						...
						newContent+='</td>';
						newContent+="<td id='activeLoans"+i+"' class='center-text'>";
						newContent+= data.SanctionLoanHolderLocal.noOfActiveLoans[i];
						newContent+='</td>';
						newContent+="<td id='overDue"+i+"' class='center-text'>";
						newContent+= data.SanctionLoanHolderLocal.outstandingAmount[i];
						newContent+='</td>';
						newContent+="<td id='outstanding"+i+"' class='center-text'>";
...
function goToRepaymentSchedule(){
	...
	document.getElementById("LoanAccountFormID").action=localStorage.contextPath+"/client/ci/loanrecovery/groups/"+globalCustomerNum+"/loanaccounts";
	document.getElementById("LoanAccountFormID").submit();
}
function showPageExpired(){
    $.mobile.showPageLoadingMsg();
	document.getElementById("LoanAccountFormID").method='POST';
	document.getElementById("LoanAccountFormID").action=localStorage.contextPath+"/client/ci/showErrorPage";
	document.getElementById("LoanAccountFormID").submit();
}
function back1(){
    $.mobile.showPageLoadingMsg();
